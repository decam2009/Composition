...
import com.boriskaloshin.composition.data.GameRepositoryImpl
...
import com.boriskaloshin.composition.domain.usecases.GenerateQuestionUseCase
import com.boriskaloshin.composition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(
    ...
    private fun startTimer() {
        timer = object : CountDownTimer(
            gameSettings.gameTypeInSeconds * MILLIS_IN_SECONDS,
            MILLIS_IN_SECONDS
        ) {
